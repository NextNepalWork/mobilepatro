                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <table class="table is-bordered table is-hoverable table is-fullwidth">
                                <h1 align="center">Weekly Horoscope</h1>
                                <thead>
                                <tr>
                                    <th>Sn</th>
                                    <th>Date</th>
                                        ...
                                        <td>
                                            <a href="#" data-target="#asdd" data-toggle="modal"
                                               class="display1 btn btn-info" data-id="{{$horo->id}}"><i
                                                        class="fa fa-info"></i>
                                                View</a>
                                            <a href="{{route('edit-horo-weekly').'/'. $horo->id}}"
                                               data-target=".bd-example-modal" class="btn btn-primary"><i
                                                        class="fa fa-edit"></i>Edit</a>
                                            <a href="{{route('delete-horo-weekly').'/'. $horo->id}}"
    ...
    <script>
        ...
        $(document).ready(function () {
            $('.display1').click(function (e) {
                ...
                var tempEditUrl = "{{route('edit-w',':id')}}";
